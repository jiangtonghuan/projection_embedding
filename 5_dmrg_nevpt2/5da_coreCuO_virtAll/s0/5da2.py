...
mf_ao.mo_coeff = load(mo_chk, "s0_coeff")
...
mol_mo.nelectron = sum(nelec) # 122
mol_mo.nao = norb # 255
...
norb_mo, nelec_mo = 26, (12, 12)
mc_mo = mcscf.CASCI(mf_mo, norb_mo, nelec_mo)
mc_mo.fix_spin_(ss=0)
...
mc_mo.chkfile = project + '_dmrg_s0.chk'
mc_mo.kernel()
...
mpt_mo.chkfile = project + '_nevpt_s0.chk'
mpt_mo.kernel()
