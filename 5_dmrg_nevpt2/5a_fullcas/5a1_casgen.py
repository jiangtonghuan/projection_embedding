...
molden.from_mo(mol, project + "_fullcas_s0.molden", np.hstack((mo_core_proj, mo_virt_proj)), occ=np.zeros(mo_core_proj.shape[1] + mo_virt_proj.shape[1]))
molden.from_mo(mol, project + "_mowith_fullcas_s0.molden", mo_coeff_new_s0, occ=mf.mo_occ)
...
molden.from_mo(mol, project + "_fullcas_s1.molden", np.hstack((mo_core_proj, mo_virt_proj)), occ=np.zeros(mo_core_proj.shape[1] + mo_virt_proj.shape[1]))
molden.from_mo(mol, project + "_mowith_fullcas_s1.molden", mo_coeff_new_s1, occ=mf.mo_occ)
